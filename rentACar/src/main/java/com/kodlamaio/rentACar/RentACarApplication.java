...
@RestControllerAdvice // hata loglama cash gibi AOP anatosyonu
public class RentACarApplication {
	...
	@ExceptionHandler //Hata olursa sen çalış 
	@ResponseStatus(code=HttpStatus.BAD_REQUEST)
	public ErrorDataResult<Object> handleBusinessExceptions(BusinessException businessExeption){
		ErrorDataResult<Object> errorDataResult = new ErrorDataResult<Object>(businessExeption.getMessage(),"BUSINESS:EXCEPTION");
		return errorDataResult;
	}
